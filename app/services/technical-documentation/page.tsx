        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="pt-24 sm:pt-32 pb-16 sm:pb-20">
                ...
                <section className="container mx-auto px-4 mb-12 sm:mb-20">
                    ...
                    >
                        <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl bg-secondary/20 flex items-center justify-center mx-auto mb-4 sm:mb-6">
                            <FileCode2 className="w-8 h-8 sm:w-10 sm:h-10 text-white drop-shadow-[0_0_20px_rgba(236,72,153,0.9)]" />
                        </div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
                            {technologies.map((tech, index) => (
                                <motion.div
                                    ...
                                    className="glass rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:border-secondary/50 transition-all duration-300 group card-hover"
                                >
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-secondary/20 flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
                                        <tech.icon className="w-5 h-5 sm:w-6 sm:h-6 text-white drop-shadow-[0_0_15px_rgba(236,72,153,0.9)]" />
                                    </div>
                ...
                <section className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <p className="text-sm sm:text-base text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed normal-case">
                            Let's create documentation that empowers your users and accelerates developer onboarding.
                        </p>
